...
document.getElementById('cutid1').controls = true;
document.getElementById('cutid2').controls = true;
...
slideButton.addEventListener('click', () => {
  console.log("into slide");
  elelment = document.getElementById('slide-container');
  elelment.classList.toggle('show');
});
